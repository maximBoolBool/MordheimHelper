...
namespace RuleEntities.Migrations
{
    ...
    [Migration("20240303181110_InitialMigrate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArmorEntityArmorSpecialRuleEntity", b =>
                {
                    ...
                    b.HasKey("ArmorId", "RulesId");

                    b.HasIndex("RulesId");

                    b.ToTable("ArmorEntityArmorSpecialRuleEntity");
                });
            ...
            modelBuilder.Entity("CloseCombatWeaponEntityCloseCombatWeaponSpecialRuleEntity", b =>
                {
                    b.Property<long>("RulesId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("RulesId", "WeaponId");

                    b.HasIndex("WeaponId");

                    b.ToTable("CloseCombatWeaponEntityCloseCombatWeaponSpecialRuleEntity");
                });

            modelBuilder.Entity("RangeWeaponEntityRangeWeaponSpecialRule", b =>
                {
                    b.Property<long>("RulesId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RangeWeaponEntityRangeWeaponSpecialRule");
                });

            modelBuilder.Entity("RangeWeaponEntityUnitEntity", b =>
                {
                    b.Property<long>("RangeWeaponsId")
                        .HasColumnType("bigint");

                    b.Property<long>("UnitsId")
                        .HasColumnType("bigint");

                    b.HasKey("RangeWeaponsId", "UnitsId");

                    b.HasIndex("UnitsId");

                    b.ToTable("RangeWeaponEntityUnitEntity");
                });
            ...
            modelBuilder.Entity("RuleEntities.Entities.SpecialRules.CloseCombatWeaponSpecialRuleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("weapon_special_rules");
                });

            modelBuilder.Entity("RuleEntities.Entities.SpecialRules.RangeWeaponSpecialRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("range_weapon_special_rules");
                });

            modelBuilder.Entity("RuleEntities.Entities.SpecialRules.UnitSpecialRuleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("UnitEntityUnitSpecialRuleEntity", b =>
                {
                    b.Property<long>("RulesId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("RulesId", "UnitId");

                    b.HasIndex("UnitId");

                    b.ToTable("UnitEntityUnitSpecialRuleEntity");
                });
            ...
            modelBuilder.Entity("ArmorEntityArmorSpecialRuleEntity", b =>
                {
                    ...
                    b.HasOne("RuleEntities.Entities.SpecialRules.ArmorSpecialRuleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CloseCombatWeaponEntityCloseCombatWeaponSpecialRuleEntity", b =>
                {
                    b.HasOne("RuleEntities.Entities.SpecialRules.CloseCombatWeaponSpecialRuleEntity", null)
                        .WithMany()
                        .HasForeignKey("RulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RuleEntities.Entities.CloseCombatWeaponEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RangeWeaponEntityRangeWeaponSpecialRule", b =>
                {
                    b.HasOne("RuleEntities.Entities.SpecialRules.RangeWeaponSpecialRule", null)
                        .WithMany()
                        .HasForeignKey("RulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RuleEntities.Entities.RangeWeaponEntity", null)
                        .WithMany()
                        .HasForeignKey("WeaponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UnitEntityUnitSpecialRuleEntity", b =>
                {
                    b.HasOne("RuleEntities.Entities.SpecialRules.UnitSpecialRuleEntity", null)
                        .WithMany()
                        .HasForeignKey("RulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
